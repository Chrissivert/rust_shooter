use bevy::prelude::*;
use crate::gameover::GameOver; // import your GameOver resource

/// Resource to track survival time
#[derive(Resource)]
pub struct SurvivalTime(pub f32);

/// Marker component for survival timer UI
#[derive(Component)]
pub struct SurvivalTimerText;
...
pub fn update_survival_time(
    ...
    // Only increment timer if the game is not over
    if !game_over.0 {
